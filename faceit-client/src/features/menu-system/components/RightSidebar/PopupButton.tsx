...
export function PopupButton({ popupBtn }: Props) {
	...
	return (
		<button
			onClick={() => dispatch(setActiveItem(popupBtn.title as PopupType))}
			className={`hover:cursor-pointer p-2.5 hover:bg-accent rounded-xl duration-300 ${isActive ? 'bg-neutral-700' : ''}`}
		>
